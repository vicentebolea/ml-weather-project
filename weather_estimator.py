...
def main(argv):
    ...
    # Fetch the data
    (train_x, train_y), (test_x, test_y) = weather_data.load_data()
    ...
    #    input_fn=lambda:weather_data.eval_input_fn(predict_x,
    #                                            labels=None,
    ...
    #    print(template.format(weather_data.SPECIES[class_id],
